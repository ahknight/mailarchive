...
setup(
    name="mailarchive",
    version="1.0.0",
    description="An interface and script to maintain an archival Maildir.",
    long_description="",

    # The project URL.
    url='https://bitbucket.org/codepoet/python-mailarchive',
    ...
    entry_points={
        'console_scripts': [
            'archivemail=mailarchive.script:start',
        ],
    },
)
